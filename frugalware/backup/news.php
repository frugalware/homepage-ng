...
if ($id == -1) {
    ...
    // First and previous
    if ($page > 1)
        print "<a href=\"" . $fwng_root . "news.php\">« " . gettext("First") . "</a>";
    if ($page > 2)
        print "<a href=\"" . $fwng_root . "news.php?page=" . ($page - 1) . "\">" . gettext("Previous") . "</a>";
    ...
    for ($i=1; $i<=$nbrPages; $i++) {
        if ($i == $page)
            ...
            print "<a href=\"" . $fwng_root . "news.php?page=" . ($i) . "\">" . ($i) . "</a>";
    }

    // Next and last
    if ($page < $nbrPages - 1)
        print "<a href=\"" . $fwng_root . "news.php?page=" . ($page + 1) . "\">" . gettext("Next") . "</a>";
    if ($page < $nbrPages)
        print "<a href=\"" . $fwng_root . "news.php?page=" . $nbrPages . "\">" . gettext("Last") . " »</a>";
