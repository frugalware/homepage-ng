...
$langcontent = '<div class="imgcontent">
	  <a href="?lang=en"><img alt="' . gettext('Change language') . '" title="' . gettext('Change language') . '" src="' . $fwng_root . 'images/english.gif" border="0" /></a>
	  | 
	  <a href="?lang=hu"><img alt="' . gettext('Change language') . '" title="' . gettext('Change language') . '" src="' . $fwng_root . 'images/hungarian.gif" border="0" /></a>
	</div>';
/*
