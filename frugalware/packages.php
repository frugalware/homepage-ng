...
function pkg_from_id($id)
{
	...
	$content .= "<tr><td>" . gettext("Darcs:") . "</td><td><a href=\"http://darcs.frugalware.org/darcsweb/darcsweb.cgi?r=frugalware-" . $arr['fwver'] . ";a=tree;f=/source/" . $parent['group']."/".$parent['pkgname']. "\">View entry</a></td></tr>\n";
	if(count($groups))
	{
