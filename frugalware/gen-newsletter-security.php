...
print "Check the description outputted by this script, it cannot always be reliable.\n\n";
...
for( $i = 0; $i < count($fsas); $i++ ) {
	...
	if ($fsas[$i][id] >= $from)
		print "\t<li>FSA" . $fsas[$i][id] . " - " . $fsas[$i][package] . ": " . $fsas[$i][shortdesc] . ". Please upgrade to " . $fsas[$i][package] . "-" . $fsas[$i][unaffected] . ".</li>\n";
