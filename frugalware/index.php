...
for ( $i=0; $i<$news_limit; $i++)
{
    ...
    $posts[$i]['title'] = "<a class=\"boxheader\" href=\"" . $fwng_root . "news?id=" . $newpost->id[0]->tagData . "\"><img class=\"face\" src=\"" . $posts[$i]['icon'] . "\" width=\"16\" alt=\"\" /> " . $newpost->title[0]->tagData."</a> " . $show;
